...
const Project=()=>{
    return(
        ...
        <a href="https://ajalaj-weather-application.herokuapp.com/" target="_blank" rel="noreferrer"><img src={weather} className="project-photo"></img></a>
        <p>Weather app that makes API calls to mapbox.com & weatherstack.com for user entered input.</p>
        </div>
        <br></br>
        <div className="project-indi glass">
        <a href="https://frosty-boyd-f33901.netlify.app/" target="_blank" rel="noreferrer"><img src={todo} className="project-photo"></img></a>
        <p>ReactJs app to help you pick what to do.</p>
        </div>
        <br></br>
        <div className="project-indi glass">
        <a href="https://to-do-app-e2e99.web.app/" target="_blank" rel="noreferrer"><img src={firebase} className="project-photo"></img></a>
